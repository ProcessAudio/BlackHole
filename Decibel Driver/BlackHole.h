...
#define                             kPlugIn_BundleID                    "audio.ProcessAudio.DecibelMonitoring"
static pthread_mutex_t              gPlugIn_StateMutex                  = PTHREAD_MUTEX_INITIALIZER;
static UInt32                       gPlugIn_RefCount                    = 0;
static AudioServerPlugInHostRef     gPlugIn_Host                        = NULL;

#define                             kBox_UID                            "DecibelMonitoringDevice"
static CFStringRef                  gBox_Name                           = NULL;
static Boolean                      gBox_Acquired                       = true;

#define                             kDevice_UID                         "DecibelMonitoringDevice"
#define                             kDevice_ModelUID                    "DecibelMonitoring_ModelUID"
...
#define                             kDataSource_ItemNamePattern         "Decibel Monitoring"

#define                             DEVICE_NAME                         "Decibel Monitoring"
#define                             MANUFACTURER_NAME                   "Process.Audio"
